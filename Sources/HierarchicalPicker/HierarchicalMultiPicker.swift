...
@MainActor public struct HierarchicalMultiPicker<Label: View, SelectionValue: Hashable, Content: View, RowContent: View, NilRowContent: View, Data: RandomAccessCollection> : View {
    ...
    /// Creates a hierarchical picker that computes its options on demand from an underlying collection of identifiable data, optionally allowing users to select multiple elements. Picker displays a custom label and a custom clear selection row.
    ...
    /// Creates a hierarchical picker that computes its options on demand from an underlying collection of identifiable data, optionally allowing users to select multiple elements. Picker generates its label from a localized string key and displays a custom clear selection row.
    ...
    @MainActor public init<ID>(data: Data, id: KeyPath<Data.Element, ID>, children: KeyPath<Data.Element, Data?>, selection: Binding<Set<SelectionValue>>, @ViewBuilder rowContent: @escaping (Data.Element) -> RowContent, @ViewBuilder label: () -> Label) where Content == OutlineGroup<Data, ID, RowContent, RowContent, DisclosureGroup<RowContent, OutlineSubgroupChildren>>, NilRowContent == Text, ID : Hashable {
        self.selection = selection
        self.rowContent = rowContent
        self.nilRowContent = Text(nilRowDefaultTitle)
        self.label = label()
    ...
    /// Creates a hierarchical picker that identifies its options based on a key path to the identifier of the underlying data, optionally allowing users to select multiple elements. Picker displays a custom label and a custom clear selection row.
    ...
    @MainActor public init<ID>(_ titleKey: LocalizedStringKey, data: Data, id: KeyPath<Data.Element, ID>, children: KeyPath<Data.Element, Data?>, selection: Binding<Set<SelectionValue>>, @ViewBuilder rowContent: @escaping (Data.Element) -> RowContent) where Content == OutlineGroup<Data, ID, RowContent, RowContent, DisclosureGroup<RowContent, OutlineSubgroupChildren>>, Label == Text, NilRowContent == Text, ID : Hashable {
        self.selection = selection
        self.rowContent = rowContent
        self.nilRowContent = Text(nilRowDefaultTitle)
        self.label = Text(titleKey)
    ...
    /// Creates a hierarchical picker that identifies its options based on a key path to the identifier of the underlying data, optionally allowing users to select multiple elements. Picker generates its label from a localized string key and displays a custom clear selection row.
